...
% define neighbors (1=neighbors, 0=no)
neighborMatrix = D<dist_threshold;
neighborMatrix = logical(neighborMatrix - eye(nChan)); % remove the diagonal (a channel is not neighbor with itself)
