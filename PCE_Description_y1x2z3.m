...
%%
% TO DO: add to PCE_description to only use statMatrix, whatever it is
...
for msIdx = 1:clusterMeasure_num
    H0distribution = [clusterMetricsH0.(clusterMeasure_lbl{msIdx})]; % TO EDIT: distribution for this specific metric
...
for clIdx = 1:nClust
    ...
    [~, ~, y1_wMedIdx, x2_wMedIdx] = PCE_y1x2Medoids(statMat,clustIdxMat);
